            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6 sm:px-16 bg-white border-b border-gray-200">
                    <div class="mt-8 text-2xl">
                        Willkommen zur V-Plan App.
                    </div>

                    <div class="mt-6 text-gray-600 max-w-xl">
                        V-Plan steht für Versammlungsplan und soll bei der Planung von Aufgaben und Terminen unterstützen. Das Dashboard ermöglicht dir direkten Zugriff auf die aktuellsten Informationen.
                    </div>
                </div>
