...
class AwaySpeakerBlock
{
    ...
    render()
    {
        ...
        if (! this._data.lastname) throw new Error('Provide at minimum a person name for the block.');
    ...
    _renderName(x, y)
    {
        this._doc
            ...
            .text(`${this._data.firstname} ${this._data.lastname}`, this._x(x), this._y(y));
    }
...
module.exports = AwaySpeakerBlock;
